...
const cn = {
  message: {
    ...
    'no_sup': '没有该商家，或已经添加关联关系',
    'file_fail': '上传失败',
    'file_success': '上传成功！',
    'upload_fail_server': '上传失败,服务器端无响应',
    'upload_fail_request': '上传失败,请求封装失败',
    'delete_success': '删除成功',
    ...
    'add_fail': '增加失败',
    'save_success': '保存成功',
    'save_fail': '保存失败,或为网络原因',
    'save_fail_errorpasswd': '保存失败,密码错误',
    'about': '关于我们',
    'feedback': '意见反馈',
    'adding_goods': '添加商品',
    'adding_price': '添加价格',
    ...
    'sales_volume': '销售额',
    'total': '总量',
    'please_input_sales_number': '请输入销售号',
    'start_time': '开始时间',
    'end_time': '结束时间',
    'submit': '提交',
    'err': '未知错误',
